locals {
      ...
      fields = concat([], [
        for item in local.mod0toparse[map_idx] : [
          for key in keys(item["value"]) : {
            ...
            is_final = item["value"][key] == null || !can(keys(item["value"][key]))
          }
        ]
      ]...)
      remaining = concat([], [
        for item in local.mod0toparse[map_idx] : [
          ...
          if item["value"][key] != null && can(keys(item["value"][key]))
        ]
      ]...)
    }
  ]
  ...
  m101 = {}
  m100 = {
    for field in lookup(local.merged_fields_by_depth, 99, {}) : field.key => {
  ...
  m99 = {
    for field in lookup(local.merged_fields_by_depth, 98, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m98 = {
    for field in lookup(local.merged_fields_by_depth, 97, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m97 = {
    for field in lookup(local.merged_fields_by_depth, 96, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m96 = {
    for field in lookup(local.merged_fields_by_depth, 95, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m95 = {
    for field in lookup(local.merged_fields_by_depth, 94, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m94 = {
    for field in lookup(local.merged_fields_by_depth, 93, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m93 = {
    for field in lookup(local.merged_fields_by_depth, 92, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m92 = {
    for field in lookup(local.merged_fields_by_depth, 91, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m91 = {
    for field in lookup(local.merged_fields_by_depth, 90, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m90 = {
    for field in lookup(local.merged_fields_by_depth, 89, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m89 = {
    for field in lookup(local.merged_fields_by_depth, 88, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m88 = {
    for field in lookup(local.merged_fields_by_depth, 87, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m87 = {
    for field in lookup(local.merged_fields_by_depth, 86, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m86 = {
    for field in lookup(local.merged_fields_by_depth, 85, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m85 = {
    for field in lookup(local.merged_fields_by_depth, 84, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m84 = {
    for field in lookup(local.merged_fields_by_depth, 83, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m83 = {
    for field in lookup(local.merged_fields_by_depth, 82, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m82 = {
    for field in lookup(local.merged_fields_by_depth, 81, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m81 = {
    for field in lookup(local.merged_fields_by_depth, 80, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m80 = {
    for field in lookup(local.merged_fields_by_depth, 79, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m79 = {
    for field in lookup(local.merged_fields_by_depth, 78, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m78 = {
    for field in lookup(local.merged_fields_by_depth, 77, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m77 = {
    for field in lookup(local.merged_fields_by_depth, 76, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m76 = {
    for field in lookup(local.merged_fields_by_depth, 75, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m75 = {
    for field in lookup(local.merged_fields_by_depth, 74, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m74 = {
    for field in lookup(local.merged_fields_by_depth, 73, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m73 = {
    for field in lookup(local.merged_fields_by_depth, 72, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m72 = {
    for field in lookup(local.merged_fields_by_depth, 71, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m71 = {
    for field in lookup(local.merged_fields_by_depth, 70, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m70 = {
    for field in lookup(local.merged_fields_by_depth, 69, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m69 = {
    for field in lookup(local.merged_fields_by_depth, 68, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m68 = {
    for field in lookup(local.merged_fields_by_depth, 67, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m67 = {
    for field in lookup(local.merged_fields_by_depth, 66, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m66 = {
    for field in lookup(local.merged_fields_by_depth, 65, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m65 = {
    for field in lookup(local.merged_fields_by_depth, 64, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m64 = {
    for field in lookup(local.merged_fields_by_depth, 63, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m63 = {
    for field in lookup(local.merged_fields_by_depth, 62, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m62 = {
    for field in lookup(local.merged_fields_by_depth, 61, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m61 = {
    for field in lookup(local.merged_fields_by_depth, 60, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m60 = {
    for field in lookup(local.merged_fields_by_depth, 59, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m59 = {
    for field in lookup(local.merged_fields_by_depth, 58, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m58 = {
    for field in lookup(local.merged_fields_by_depth, 57, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m57 = {
    for field in lookup(local.merged_fields_by_depth, 56, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m56 = {
    for field in lookup(local.merged_fields_by_depth, 55, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m55 = {
    for field in lookup(local.merged_fields_by_depth, 54, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m54 = {
    for field in lookup(local.merged_fields_by_depth, 53, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m53 = {
    for field in lookup(local.merged_fields_by_depth, 52, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m52 = {
    for field in lookup(local.merged_fields_by_depth, 51, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m51 = {
    for field in lookup(local.merged_fields_by_depth, 50, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m50 = {
    for field in lookup(local.merged_fields_by_depth, 49, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m49 = {
    for field in lookup(local.merged_fields_by_depth, 48, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m48 = {
    for field in lookup(local.merged_fields_by_depth, 47, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m47 = {
    for field in lookup(local.merged_fields_by_depth, 46, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m46 = {
    for field in lookup(local.merged_fields_by_depth, 45, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m45 = {
    for field in lookup(local.merged_fields_by_depth, 44, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m44 = {
    for field in lookup(local.merged_fields_by_depth, 43, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m43 = {
    for field in lookup(local.merged_fields_by_depth, 42, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m42 = {
    for field in lookup(local.merged_fields_by_depth, 41, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m41 = {
    for field in lookup(local.merged_fields_by_depth, 40, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m40 = {
    for field in lookup(local.merged_fields_by_depth, 39, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m39 = {
    for field in lookup(local.merged_fields_by_depth, 38, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m38 = {
    for field in lookup(local.merged_fields_by_depth, 37, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m37 = {
    for field in lookup(local.merged_fields_by_depth, 36, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m36 = {
    for field in lookup(local.merged_fields_by_depth, 35, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m35 = {
    for field in lookup(local.merged_fields_by_depth, 34, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m34 = {
    for field in lookup(local.merged_fields_by_depth, 33, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m33 = {
    for field in lookup(local.merged_fields_by_depth, 32, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m32 = {
    for field in lookup(local.merged_fields_by_depth, 31, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m31 = {
    for field in lookup(local.merged_fields_by_depth, 30, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m30 = {
    for field in lookup(local.merged_fields_by_depth, 29, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m29 = {
    for field in lookup(local.merged_fields_by_depth, 28, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m28 = {
    for field in lookup(local.merged_fields_by_depth, 27, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m27 = {
    for field in lookup(local.merged_fields_by_depth, 26, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m26 = {
    for field in lookup(local.merged_fields_by_depth, 25, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m25 = {
    for field in lookup(local.merged_fields_by_depth, 24, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m24 = {
    for field in lookup(local.merged_fields_by_depth, 23, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m23 = {
    for field in lookup(local.merged_fields_by_depth, 22, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m22 = {
    for field in lookup(local.merged_fields_by_depth, 21, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m21 = {
    for field in lookup(local.merged_fields_by_depth, 20, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m20 = {
    for field in lookup(local.merged_fields_by_depth, 19, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m19 = {
    for field in lookup(local.merged_fields_by_depth, 18, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m18 = {
    for field in lookup(local.merged_fields_by_depth, 17, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m17 = {
    for field in lookup(local.merged_fields_by_depth, 16, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m16 = {
    for field in lookup(local.merged_fields_by_depth, 15, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m15 = {
    for field in lookup(local.merged_fields_by_depth, 14, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m14 = {
    for field in lookup(local.merged_fields_by_depth, 13, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m13 = {
    for field in lookup(local.merged_fields_by_depth, 12, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m12 = {
    for field in lookup(local.merged_fields_by_depth, 11, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m11 = {
    for field in lookup(local.merged_fields_by_depth, 10, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m10 = {
    for field in lookup(local.merged_fields_by_depth, 9, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m9 = {
    for field in lookup(local.merged_fields_by_depth, 8, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m8 = {
    for field in lookup(local.merged_fields_by_depth, 7, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m7 = {
    for field in lookup(local.merged_fields_by_depth, 6, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m6 = {
    for field in lookup(local.merged_fields_by_depth, 5, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m5 = {
    for field in lookup(local.merged_fields_by_depth, 4, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m4 = {
    for field in lookup(local.merged_fields_by_depth, 3, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m3 = {
    for field in lookup(local.merged_fields_by_depth, 2, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m2 = {
    for field in lookup(local.merged_fields_by_depth, 1, {}) : field.key => {
      final_val = field.value,
      sub_val = {
  ...
  m1 = {
    for field in lookup(local.merged_fields_by_depth, 0, {}) : field.key => {
      final_val = field.value,
      sub_val = {
