variable "maps" {
  ...
  validation {
    ...
    error_message = "The `var.maps` variable must be a list of maps and/or objects. The provided value is not a list."
  }
  validation {
    condition = !can(
      index(
    ...
    error_message = "The `var.maps` variable must be a list of maps and/or objects. Not all elements meet this requirement."
  }
}
